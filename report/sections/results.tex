...
\begin{tabular}{lll}
\toprule
\textbf{Cluster} & \textbf{Top Attributes (Stemmed)} & \textbf{Inferred Topic}\\
\midrule
CLASS0 & how , inform, import, understand, understand & General Research\\
CLASS1 & equat, theori, solut, deriv, space & Mathematics\\
CLASS2 & quantum, phase, physic, experiment, transit & Quantum Physics\\
CLASS3 & increas, temperatur, investig, valu, found & Thermodynamics\\
CLASS4 & prove, ani, given, bound, some, known & Theoretical CS/Math\\
CLASS5 & learn, network, train, deep, dataset & Machine Learning\\
CLASS6 & mass, star, galaxi, stellar, emiss & Astrophysics\\
CLASS7 & optim, effici, bound, linear, complex & Optimisation\\
\bottomrule
\end{tabular}
